...
export default function ParentEditComponent() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8080/api/parents/${id}`)
      .then((res) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updateResp = await axios.put(
        `http://localhost:8080/api/parents/${id}`,
        formData
      );
      ...
      if (profileImage) {
        ...
        const imageResp = await axios.put(
          `http://localhost:8080/api/parents/${id}/upload-image`,
          imageData,
          {
            headers: {
  ...
  return (
    <div className="mt-4 bg-[var(--bg-dark)] rounded-xl shadow-md min-h-screen p-6 bg-bg">
      ...
      <h1 className="text-2xl font-bold text-text mb-6 flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className=" lg:col-span-1">
          <div className="bg-[var(--bg-light)] rounded-xl shadow-md p-6">
        ...
        <div className="lg:col-span-1 ">
          <div className="bg-[var(--bg-light)] rounded-xl shadow-neutral-700 p-6  border-border-muted">
          ...
          <div className="bg-[var(--bg-light)] rounded-xl shadow-md p-6 ">
              ...
              {selectedStudents.length === 0 ? (
                ...
                <div className="space-y-2">
                  {selectedStudents.map((student) => (
                    <div
                      key={student.id}
                      className="flex items-center justify-between bg-bg-dark p-3 rounded border"
                    >
                      <div>
                      ...
                      <button
                        ...
                        className="text-danger hover:text-danger-dark p-1 hover:cursor-pointer rounded-full hover:bg-bg"
                      >
                        <FaMinus />
                      </button>
                    </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-4 max-h-64 overflow-y-auto mb-4">
                {filteredStudents.length === 0 ? (
                  ...
                  filteredStudents.map((student) => (
                    <div
                      key={student.id}
                      className="border border-border rounded-lg p-3 hover:bg-bg-dark"
                    >
                      <div className="flex justify-between items-start">
                        ...
                        {selectedStudents.some((s) => s.id === student.id) ? (
                          <button
                            className="text-success hover:cursor-pointer flex items-center"
                            disabled
                          >
                          ...
                          <button
                            ...
                            className="text-primary hover:cursor-pointer hover:text-highlight flex items-center"
                          >
              ...
              <button
                ...
                className="w-full hover:cursor-pointer bg-secondary text-text py-2 px-4 rounded-md hover:bg-secondary-dark focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2"
              >
